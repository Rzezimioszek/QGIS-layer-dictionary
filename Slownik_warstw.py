...
from .Slownik_warstw_dialog import SlownikWarstwDialog
import os.path
...
class SlownikWarstw:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'SlownikWarstw_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Slownik warstw')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('SlownikWarstw', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/Slownik warstw/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Slownik warstw'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Slownik warstw'),
                action)
            self.iface.removeToolBarIcon(action)
            
    def select_output_file(self):
        filename, _filter = QFileDialog.getSaveFileName(self.dlg, "Wybierz plik wynikowy ", "", ("plik tekstowy (*.txt)"))
    ...
    def load_field_table(self):
        ...
        itemLabels = ['Pola', 'Pola SHP']  # , 'Typ pola']
    ...
    def run(self):
        ...
        if result:
            ...
            with open(filename, "a") as file:
                file.write(f"Table\tField QPKG\tField SHP\n")
                ...
                for item in self.dlg.listWidget.selectedItems():
                    ...
                    for field in field_names:
                        ...
                        temp_shp = field[:10]
                        i = 0
                        while (temp_shp in lst_shp):
                            i += 1
                            if i < 10:
                                temp_shp = f"{temp_shp[:8]}_{i}"
                            else:
                                temp_shp = f"{temp_shp[:8]}{i}"
            ...
            "Udało się!", "Zapisano słownik w  " + filename,
